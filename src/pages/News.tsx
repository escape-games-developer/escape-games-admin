              ...
              >
                ...
                <div className="modalBody">
                  ...
                  >
                    ...
                    {/* FILA 2: Link + Estado + Notificación */}
                    <label className="field" style={{ gridColumn: "span 1" }}>
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setEditing({ ...editing, ctaLink: e.target.value })
                        }
                        placeholder="https://..."
                        inputMode="url"
                      />
                    ...
                    <label className="field" style={{ gridColumn: "span 1" }}>
  <span className="label">Notificación</span>
  <label
    className="input"
    style={{
      display: "flex",
  ...
  >
    ...
    >
      Enviar push al publicar
    </span>
  </label>
</label>

                    {/* FILA 3: Descripción + editores */}
                    <div className="field" style={{ gridColumn: "1 / -1" }}>
                      ...
                      >
                        ...
                        <button
                          ...
                          className="ghostBtn"
                          onClick={() =>
                            emojiOpen ? setEmojiOpen(false) : openEmoji()
                          }
                          title="Emojis"
    ...
    >
      Quitar imagen
                      ...
                      {editing.image ? (
                        ...
                        >
                          Click en la imagen para recortarla.
                        </div>
                      ) : null}
                    </div>
                  </div>
